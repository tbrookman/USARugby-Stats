 ...
 $("#addscore").live('submit', function() {
    ...
    $('.error').hide();
      ...
      return false;
    		...
    		var game_score = '/competition/game_score.php?id=' + game_id;
	...
	//event.preventDefault();
		...
		$.post('http://usarugby.us/competition/add_sub_process.php', 
    ...
    $('.error').hide();
      ...
      return false;
		...
		$.post('http://usarugby.us/competition/add_card_process.php', 
	...
	$(".dScore").live('click', function() {
		...
		$.post('http://usarugby.us/competition/delete_score_process.php', 
	...
	$(".dSub").live('click', function() {
		...
		$.post('http://usarugby.us/competition/delete_sub_process.php', 
		{id: dId, game_id: game_id},
		function(){
	...
	$(".dCard").live('click', function() {
		...
		$.post('http://usarugby.us/competition/delete_card_process.php', 
		{id: dId, game_id: game_id},
		function(){
	...
	$(".hidec").live('click', function() {
		...
		$.post('http://usarugby.us/competition/hide_comp_process.php', 
		{id: hId},
		function(){
	...
	//event.preventDefault();
		...
		$.post('http://usarugby.us/competition/add_game_process.php', 
	...
	//event.preventDefault();
		...
		if (team == "") {
    		...
    		var comp_id = $("#comp_id").val();
		$.post('http://usarugby.us/competition/add_team_process.php', 
		...
		function(){
         		...
         		$('#addgamediv').fadeOut('slow', function(){
		     		...
		     		$('#addgamediv').fadeIn('fast');
       				$('#addgamediv').load('/competition/add_game.php?id='+comp_id, function(){
	...
	if(!confirm('Are you sure you want to delete this game?')){return false;}
		...
		$.post('http://usarugby.us/competition/delete_game_process.php', 
		{game_id: dId},
		function(){
		     	$('#games').fadeOut('slow', function(){
		     		$('#games').html('Please wait...');
	...
	if(!confirm('Are you sure you want to delete this team from this competition?')){return false;}
		...
		$.post('http://usarugby.us/competition/delete_team_process.php', 
		...
		function(){
         		...
         		$('#addteamdiv').fadeOut('slow', function(){
		     		$('#addteamdiv').html('Please wait...');
		     		$('#addteamdiv').fadeIn('fast');
       				$('#addteamdiv').load('/competition/add_team.php?id='+comp_id, function(){
         			$('#addteamdiv').fadeIn('slow');
         			});
         		});			
	...
	if(!confirm('Change signoff status?')){return false;}
		...
		$.post('http://usarugby.us/competition/signatures_process.php', 
	...
	//show edit info
		...
		$('#info').fadeIn('fast');
       		$('#info').load('/competition/edit_game_info.php?id='+game_id, function(){
         	$('#info').fadeIn('slow');
         	});
	...
	if(!confirm('Update game info as shown?')){return false;}
		...
		if (kom == "") {
    		...
    		var refresh = '/competition/game_info.php?id='+game_id;
		
		$.post('http://usarugby.us/competition/edit_game_info_process.php', 
	...
	if(!confirm('Update roster?')){return false;}
		...
		$('.error').hide();
	  	...
	  	players = players+val+'-';
    		...
    		var refresh = '/competition/edit_event_roster.php?id='+roster_id;
		$.post('http://usarugby.us/competition/edit_event_roster_process.php', 
	...
	if(!confirm('Update roster?')){return false;}
		...
		$('.error').hide();
	  	...
	  	var val = $("#"+temp+":checked").val()
    		...
    		var refresh = '/competition/edit_game_roster.php?gid='+game_id+'&tid='+team_id;
    		
		$.post('http://usarugby.us/competition/edit_game_roster_process.php', 
	...
	if(!confirm('Update roster?')){return false;}
		...
		$.post('http://usarugby.us/competition/edit_game_roster_previous_process.php', 
	...
	if(!confirm('Add club to database?')){return false;}
		...
		if (num == "") {
    		...
    		$.post('http://usarugby.us/competition/db_update_team_check.php', 
		{name: name, num: num},
		function(data){
		     	if(data!=''){
		     	alert(data);
    		...
    		var refresh = '/competition/db_update_team_list.php';
    		
		$.post('http://usarugby.us/competition/db_update_team_process.php', 
	...
	if(!confirm('Are you sure you want to delete this user?')){return false;}
		...
		$.post('http://usarugby.us/competition/delete_user_process.php', 
		{user_id: dId},
		function(){
	...
	//show edit info for users
    		...
    		$('#users').html('Please wait...');
		$('#users').fadeIn('fast');
       		$('#users').load('/competition/edit_user.php?id='+eId, function(){
         	$('#users').fadeIn('slow');
         	});
	...
	if(!confirm('Update user info as shown?')){return false;}
		...
		$.post('http://usarugby.us/competition/edit_user_process.php', 
	...
	$("#addUser").live('click', function() {
		...
		$.post('http://usarugby.us/competition/add_user_process.php', 
